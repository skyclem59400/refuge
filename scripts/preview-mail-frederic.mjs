/**
 * Preview HTML local du mail envoyé à Frédéric Bricout
 * (variante perso : tu+prénom, texte sur mesure subvention fourgon + portage CA2C 1,25 €).
 */
...
const greeting = 'Bonjour Frédéric,'
...
const customThanks = `Au-delà du caractère convivial de cette journée, je tenais à te remercier personnellement. Ton soutien sur de nombreux sujets, notamment ton aide précieuse pour l'obtention de la subvention du fourgon, ta disponibilité et ton suivi régulier comptent énormément pour la SDA. Je sais aussi que tu portes activement le sujet du passage à <strong>1,25 €/habitant</strong> au sein de la CA2C, et c'est un combat que nous apprécions sincèrement.</p>
...
const outPath = '/tmp/preview-mail-frederic.html'
